...
\begin{DoxyCompactList}\small\item\em Structure type to access the Nested Vectored Interrupt \doxylink{struct_controller}{Controller} (NVIC). \end{DoxyCompactList}\end{DoxyCompactItemize}
\begin{DoxyCompactItemize}
\item 
